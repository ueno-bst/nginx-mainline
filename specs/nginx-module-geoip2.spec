...
Version: ${NGINX_VERSION}+${NGX_GEOIP2_VERSION}
...
Source100: https://github.com/leev/ngx_http_geoip2_module/archive/${NGX_GEOIP2_VERSION}.tar.gz#/ngx_http_geoip2_module-${NGX_GEOIP2_VERSION}.tar.gz
