...
Summary: nginx redis2 dynamic modules
Name: nginx-module-redis2
Version: ${NGINX_VERSION}+${NGX_REDIS2_VERSION}
...
Source100: https://github.com/openresty/redis2-nginx-module/archive/v${NGX_REDIS2_VERSION}.tar.gz#/redis2-nginx-module-${NGX_REDIS2_VERSION}.tar.gz
